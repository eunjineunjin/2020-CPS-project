...
은진: 구글 firebase를 이용하여 푸시 알림을 받는 어플을 개발하였다. 이후 서버에서 자동으로 알림을 보내도록 파이썬 코드(AutomaticFCM.py)를 작성하였으나 인증 오류가 발생하여 실패하였다.
### 20.06.10
...
은진: 어플이 서버로부터 정보를 받아와 출력하도록 하기 위해 jsoup을 사용하였다. 데이터를 출력하기 위해 리스트를 만들었다.
### 20.06.13
<모든 팀원>
